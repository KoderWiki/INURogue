...
class Shadowpunch(Skill):
    def __init__(self, game, skill = 'shadowpunch', path = 'asset/images/skill/shadowpunch/0.png', scale = 7.0, animation_time = 200):
        ...
        self.idle_image = self.img_update(self.skill_images, 2.0)
